...
extension UIScrollView{
	...
	func enablePanoramaIndicator(){
		...
		if self.getBackgroundViewForPanoramaIndicator() == nil && self.getViewForPanoramaIndicator() == nil{
			...
			self.setBackgroundViewForPanoramaIndicator(backgroundViewScrollIndicator: backgroundViewScrollIndicator)
			...
			let scrollIndicatorFrame:CGRect = CGRect(x: self.contentOffset.x + (self.frame.size.width / 2) - (backgroundIndicatorWidth / 2), y: self.frame.size.height - ScrollIndicatorHeight - ScrollIndicatorBottomSpace, width: backgroundIndicatorWidth, height: ScrollIndicatorHeight)
			...
			self.setViewForPanoramaIndicator(viewScrollIndicator: viewScrollIndicator)
